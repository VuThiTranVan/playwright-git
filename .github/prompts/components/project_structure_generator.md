...
sites:
  - name: 'site-a'
    base_url: 'https://site-a-staging.company.com'
    login_url: 'https://site-a-staging.company.com/login'
    auth_fields:
      - name: 'email'
      ...
      - name: 'password'
        ...
        example: 'password123'
  - name: 'site-b'
    base_url: 'https://site-b-staging.company.com'
    login_url: 'https://site-b-staging.company.com/signin'
    auth_fields:
      - name: 'username'
